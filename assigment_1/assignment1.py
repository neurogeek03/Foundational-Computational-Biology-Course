...
# This part saves the code in an output.txt file. 
with open('output.txt', 'w') as file:
    ...
    assignment_pdf_path = "/Users/marlenfaf/Desktop/UofT - PhD/MMG1344H/Foundational-Computational-Biology-Course/FCBI_Assignment_1_Instructions_2025-1.pdf"
...
# After this block, the output will go back to the console
